...
const SubscriptionIcon = ({ size = 24, color = "#1a56db" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const SupportIcon = ({ size = 24, color = "#1a56db" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" />
    <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
    <line x1="12" y1="17" x2="12" y2="17.01" strokeWidth="2.5" />
...
const LinesIcon = ({ size = 26, color = "#1a56db" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const StudentsStatIcon = ({ size = 26, color = "#1a56db" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const TripsIcon = ({ size = 26, color = "#1a56db" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="4" width="18" height="18" rx="2" />
    <path d="M16 2v4M8 2v4M3 10h18" />
  </svg>
...
const StudentAvatar = () => (
  <svg width="110" height="130" viewBox="0 0 110 130" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="55" cy="108" rx="35" ry="22" fill="#dbeafe" />
    <path d="M20 130 Q20 95 55 95 Q90 95 90 130" fill="#1e40af" />
    <path d="M46 95 Q55 110 64 95" fill="#1a56db" opacity="0.4" />
    <rect x="49" y="82" width="12" height="15" rx="4" fill="#fde8d8" />
    <ellipse cx="55" cy="67" rx="20" ry="22" fill="#fde8d8" />
    <ellipse cx="55" cy="49" rx="20" ry="9" fill="#1a1a2e" />
    <ellipse cx="37" cy="59" rx="3.5" ry="7" fill="#1a1a2e" />
    <circle cx="47" cy="66" r="2.5" fill="#1a1a2e" />
    <circle cx="63" cy="66" r="2.5" fill="#1a1a2e" />
    <circle cx="47.8" cy="65.2" r="0.9" fill="#fff" />
    <circle cx="63.8" cy="65.2" r="0.9" fill="#fff" />
    <path d="M49 74 Q55 80 61 74" stroke="#e07050" strokeWidth="1.5" fill="none" strokeLinecap="round" />
    <rect x="63" y="102" width="12" height="18" rx="3" fill="#374151" />
    <rect x="65" y="104" width="8" height="12" rx="1" fill="#60a5fa" />
    <path d="M20 108 Q14 113 18 122" stroke="#1e40af" strokeWidth="7" strokeLinecap="round" fill="none" />
    <path d="M90 108 Q96 111 76 114" stroke="#1e40af" strokeWidth="7" strokeLinecap="round" fill="none" />
  </svg>
);
...
const navItems = [
  ...
  { id: "about",     label: "About",     Icon: AboutIcon,     href: "#about" },
  { id: "help",      label: "Help",      Icon: HelpIcon,      href: "#help" },
];

const featureStrip = [
  { Icon: CalendarFeatureIcon, title: "View Schedules",      desc: "Check bus timings and plan your day." },
  { Icon: RouteFeatureIcon,    title: "Track Your Route",    desc: "Know your line, station and next bus." },
  { Icon: SubscriptionIcon,   title: "Manage Subscription", desc: "View, renew and manage your subscription." },
  { Icon: NotifyIcon,         title: "Get Notified",        desc: "Receive alerts for delays, changes and more." },
  { Icon: SupportIcon,        title: "Help & Support",      desc: "Report issues and get quick assistance." },
];

const stats = [
  { Icon: BusStatIcon,      value: "45+",    label: "Buses" },
  { Icon: LinesIcon,        value: "18",     label: "Transport Lines" },
  { Icon: StudentsStatIcon, value: "3,800+", label: "Students" },
  { Icon: TripsIcon,        value: "120+",   label: "Daily Trips" },
];
    ...
    <div className={styles.page}>
      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.navRight}>
          <Link href="/student/login" className={styles.navBtn}>
      ...
      {mobileMenuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <Link href="/student/login" className={styles.mobileNavBtn} onClick={() => setMobileMenuOpen(false)}>
            <LoginIcon size={14} color="#fff" /> Student Login
          </Link>
        </div>
      )}
      ...
      <section className={styles.hero} id="home">
        ...
        <div className={styles.heroRight}>
          ...
          <div className={styles.planCard}>
            ...
            <Link href="/student/login" className={styles.planSearchBtn}>
      ...
      {/* ── Feature strip ── */}
      <section className={styles.featureStrip} id="services">
        {featureStrip.map((f) => (
      ...
      <section className={styles.statsSection} id="about">
        <div className={styles.statsLeft}>
          <div className={styles.statsAvatar}>
            <StudentAvatar />
          </div>
          <div className={styles.statsPromoText}>
            <p className={styles.statsPromoTitle}>
              Everything you need for a smooth and smart commute.
            </p>
            <p className={styles.statsPromoDesc}>
              All the transport information at your fingertips. Anytime, anywhere.
            </p>
          </div>
        </div>
