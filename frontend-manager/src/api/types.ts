...
export interface LineChangeFunnelStage {
  stage: string;
  value: number;
}

export interface LineChangeByMonth {
  month: string;
  changes: number;
}

export interface StationDensityPoint {
  station: string;
  station_id: number;
  active_subscriptions: number;
  bubble_size: number;
...
export interface PeakBoardingHour {
  hour: string;
  boardings: number;
}
...
export interface ReportData {
  ...
  totals: ReportTotals;
  // Statistics additions
  subscription_trend?: SubscriptionTrendPoint[];
  line_change_funnel?: LineChangeFunnelStage[];
  line_change_by_month?: LineChangeByMonth[];
  station_density?: StationDensityPoint[];
  peak_boarding_hours?: PeakBoardingHour[];
}
